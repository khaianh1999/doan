    ...
    <div class="row">
        <div class="col-lg-12 order-lg-1">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.customers.store') }}" autocomplete="off" id="myform">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control custom-select" name="gender" style="width:100%;">
                                        <option value="1" @if (old('gender') == 0) selected="selected" @endif>
                                            Nam</option>
                                        <option value="0" @if (old('gender') == 1) selected="selected" @endif>
                                            Nữ</option>
